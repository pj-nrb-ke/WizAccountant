# QA Checklist — Task #24: Reports — Vendor (aged creditors, statement, ledger)
...
### Aged Creditors
- [ ] **CRITICAL** Returns suppliers in 30/60/90/120+ day buckets
- [ ] All suppliers with outstanding balance included
- [ ] Bucket totals sum correctly

### Supplier Statement
- [ ] **CRITICAL** Returns txns for given supplier + date range
- [ ] Opening balance, transactions, closing balance present

### Supplier Ledger
- [ ] **CRITICAL** Returns full ledger txn list; debit/credit correct

### Consistency
- [ ] Structure mirrors customer reports exactly
