# QA Checklist — Task #23: Reports — Customer (aged debtors, statement, ledger)
...
### Aged Debtors
- [ ] **CRITICAL** Returns customers grouped in 30/60/90/120+ day buckets
- [ ] All customers with outstanding balance included
- [ ] Bucket totals sum to total outstanding (spot-check 2 customers)

### Customer Statement
- [ ] **CRITICAL** Returns transactions for given customer + date range
- [ ] Opening balance, transactions, closing balance all present
- [ ] Date range filter works correctly

### Customer Ledger
- [ ] **CRITICAL** Returns full ledger transaction list
- [ ] Debit/credit columns correct; running balance correct

### Contract & Performance
- [ ] QueryResult rows + ExplainabilityEnvelope
- [ ] Registered in HandlerCapabilityRegistry
- [ ] Responds in < 3 s for up to 500 records
